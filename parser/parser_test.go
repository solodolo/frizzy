	...
	var tests = []struct {
		...
		},
		{
			...
			nodes: []TreeNode{
				...
				NonTerminalParseNode{Value: "F"},
				StringParseNode{Value: "}}"},
				NonTerminalParseNode{Value: "Q"},
				StringParseNode{Value: "if"},
				StringParseNode{Value: "("},
				NonTerminalParseNode{Value: "K"},
				StringParseNode{Value: ")"},
				NonTerminalParseNode{Value: "V"},
				NonTerminalParseNode{Value: "S"},
				NonTerminalParseNode{Value: "T"},
				StringParseNode{Value: "end"},
				NonTerminalParseNode{Value: "L"},
				NonTerminalParseNode{Value: "G"},
				StringParseNode{Value: "else_if"},
				StringParseNode{Value: "("},
				NonTerminalParseNode{Value: "K"},
				StringParseNode{Value: ")"},
				NonTerminalParseNode{Value: "V"},
				StringParseNode{Value: "else"},
				NonTerminalParseNode{Value: "V"},
				NonTerminalParseNode{Value: "M"},
				NonTerminalParseNode{Value: "G"},
				NonTerminalParseNode{Value: "F"},
